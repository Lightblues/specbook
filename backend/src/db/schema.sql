-- Specbook Database Schema v0.4
-- Uses short IDs (8-char base62) instead of UUIDs for external entities
...
-- Projects (public view, member edit)
...
-- Tags (keep UUID for internal use)
